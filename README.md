# Physical AI & Humanoid Robotics Textbook - RAG Chatbot Integration

## Project Overview
This repository contains the "Physical AI & Humanoid Robotics" AI-native textbook with an integrated RAG (Retrieval-Augmented Generation) chatbot. The textbook is built with Docusaurus and allows users to ask questions about the content and receive contextual answers with source citations.
...
- **FastAPI Backend**: REST API with /chat and /rag endpoints for RAG processing
...
- `POST /chat` - Chat endpoint accepting question and context
- `POST /rag` - RAG endpoint accepting query and source_url
...
This site can be deployed to GitHub Pages, Vercel, Netlify, or any static hosting service.
